...
#> (Intercept)    minority      female         ses 
#>   14.149102   -2.868687   -1.318437    2.067309 
#>     meanses 
#>    2.833490
fixef(modList)
#> (Intercept)    minority      female         ses 
#>   14.028792   -2.680352   -1.213086    1.966725 
#>     meanses 
#>    3.141636
```
...
#> $imp1
#> (Intercept)    minority      female         ses 
#>   13.976636   -2.587948   -1.170291    1.984663 
#>     meanses 
#>    3.170845 
#> 
#> $imp2
#> (Intercept)    minority      female         ses 
#>   14.070484   -2.673140   -1.294932    1.959564 
#>     meanses 
#>    3.143996 
#> 
#> $imp3
#> (Intercept)    minority      female         ses 
#>   14.040516   -2.728450   -1.215497    1.958265 
#>     meanses 
#>    3.134720 
#> 
#> $imp4
#> (Intercept)    minority      female         ses 
#>   14.030150   -2.698588   -1.214679    1.997264 
#>     meanses 
#>    3.081103 
#> 
#> $imp5
#> (Intercept)    minority      female         ses 
#>   14.026175   -2.713636   -1.170030    1.933870 
#>     meanses 
#>    3.177518
```
...
#> Formula: 
#> mathach ~ minority + female + ses + meanses + (1 + ses | schid)
#>    Data: d
#> 
...
#> (Intercept)   14.029     0.174    80.566
#> female        -1.213     0.160    -7.574
#> meanses        3.142     0.358     8.769
#> minority      -2.680     0.202   -13.289
#> ses            1.967     0.120    16.372
#>                     df
#> (Intercept)  99310.593
#> female       16493.051
#> meanses     259740.570
...
#>                        term    group   estimate
#> 1 cor_(Intercept).ses.schid    schid -0.5247666
#> 2      sd_(Intercept).schid    schid  1.5183804
#> 3   sd_Observation.Residual Residual  5.9703034
#> 4              sd_ses.schid    schid  0.6468874
#>     std.error
#> 1 0.084101895
#> 2 0.008713530
#> 3 0.006244066
...
#> 1 (Intercept) 14.028792 0.1741275  80.566201
#> 2      female -1.213086 0.1601572  -7.574345
#> 3     meanses  3.141636 0.3582833   8.768580
#> 4    minority -2.680352 0.2017037 -13.288566
#> 5         ses  1.966725 0.1201239  16.372467
#>          df
#> 1  99310.59
#> 2  16493.05
#> 3 259740.57
