...
#> 1         s       1 (Intercept)  0.18042888
#> 2         s       2 (Intercept) -0.07034954
#> 3         s       3 (Intercept)  0.32105622
#> 4         s       4 (Intercept)  0.23713963
#> 5         s       5 (Intercept)  0.02613185
#> 6         s       6 (Intercept)  0.10806580
#>        median        sd
#> 1  0.21906223 0.3145710
#> 2 -0.06339508 0.2972897
#> 3  0.33625741 0.3187445
#> 4  0.23271723 0.2761635
#> 5  0.02878794 0.3054642
#> 6  0.11082677 0.2429651
```
...
#> failed to converge with max|grad| = 0.0071146
