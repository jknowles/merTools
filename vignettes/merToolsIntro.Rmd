...
date: "Written 2015-05-27 (last updated 2026-05-29)"
...
effects provided by the `arm::sim()` function. *groupID* represents the identifiable
...
More interesting, let's programmatically modify this observation to see how the
...
Here we can see that group level 2518
