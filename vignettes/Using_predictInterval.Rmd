...
#> Chain 1: 
#> Chain 1: 
#> Chain 1:  Elapsed Time: 9.585 seconds (Warm-up)
#> Chain 1:                3.35 seconds (Sampling)
#> Chain 1:                12.935 seconds (Total)
#> Chain 1:
...
|:------------------------|---------:|--------:|-------:|
|predictInterval()        |      0.52|     0.00|    0.51|
|arm::sim()               |      0.88|     0.00|    0.87|
|lme4::bootMer()-Method 1 |      8.57|     0.00|    8.72|
|lme4::bootMer()-Method 2 |      8.84|     0.03|    9.01|
|lme4::bootMer()-Method 3 |      8.90|     0.02|    9.08|
|rstanarm:predict         |     13.80|     0.00|   13.94|
