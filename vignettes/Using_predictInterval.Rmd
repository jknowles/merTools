...
#> Chain 1: 
#> Chain 1: 
#> Chain 1:  Elapsed Time: 6.923 seconds (Warm-up)
#> Chain 1:                2.445 seconds (Sampling)
#> Chain 1:                9.368 seconds (Total)
#> Chain 1:
...
|:------------------------|---------:|--------:|-------:|
|predictInterval()        |      0.35|     0.01|    0.36|
|arm::sim()               |      0.58|     0.01|    0.60|
|lme4::bootMer()-Method 1 |      5.70|     0.08|    5.83|
|lme4::bootMer()-Method 2 |      5.69|     0.05|    5.78|
|lme4::bootMer()-Method 3 |      5.61|     0.04|    5.72|
|rstanarm:predict         |      9.70|     0.12|    9.84|
